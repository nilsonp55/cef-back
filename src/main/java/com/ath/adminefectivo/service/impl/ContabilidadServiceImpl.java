...
public class ContabilidadServiceImpl implements IContabilidadService {
  ...
  public int generarContabilidad(String tipoContabilidad,
    ...
    listadoOperacionesProgramadas.forEach(operacionProgramada -> this
        .procesarRegistrosContabilidad(tipoContabilidad, operacionProgramada, fechaSistema));
  ...
  public int generarContabilidadIntradia(String tipoContabilidad,
    ...
    listadoOperacionesProgramadasIntradia
        .forEach(operacionIntradia -> procesarRegistrosContabilidadIntradia(tipoContabilidad,
  ...
  public ContabilidadDTO generarRespuestaContabilidad(Date fechaSistema, String tipoContabilidad,
    ...
    ConteoContabilidadDTO conteoContabilidadDTO =
        transaccionesContablesService.generarConteoContabilidad(fechaSistema, tipoContabilidad);
    ...
    List<RespuestaContableDTO> respuestaContableDTO =
        transaccionesContablesService.getCierreContable(fechaSistema, tipoContabilidad, 0);
  ...
  public void procesoEliminarExistentes(String tipoContabilidad,
    ...
    transaccionesContablesService.deleteTransaccionesContablesByFechasAndTipoProceso(fechaInicio,
        fechaFin, tipoContabilidad);
    transaccionesInternasService.deleteTransaccionesInternasByFechasAndTipoProceso(fechaInicio,
        fechaFin, tipoContabilidad);
   ...
   * @return
   */
  private int procesarRegistrosContabilidad(String tipoContabilidad,
      OperacionesProgramadasDTO operacionProgramada, Date fechaSistema) {
    if (tipoContabilidad.equals("PM")) {
      if (operacionProgramada.getTipoOperacion().equals("CONSIGNACION")
          && !operacionProgramada.isEsCambio()) {
        return this.procesarContabilidadConsignacion(tipoContabilidad, operacionProgramada,
            fechaSistema);
      }
      if (operacionProgramada.getTipoOperacion().equals("RETIRO")
          && !operacionProgramada.isEsCambio()) {
    ...
    if (tipoContabilidad.equals("AM")) {
      ...
      if (operacionProgramada.getTipoOperacion().equals("INTERCAMBIO")) {
        return this.procesarContabilidadIntercambio(tipoContabilidad, operacionProgramada,
            fechaSistema);
      } else if (operacionProgramada.getTipoOperacion().equals("CONSIGNACION")
          && operacionProgramada.isEsCambio()) {
  ...
  private void procesarRegistrosContabilidadIntradia(String tipoContabilidad,
    ...
    TransaccionesInternasDTO operacionIntradia11 =
        generarTransaccionInternaIntradia(tipoContabilidad, "C", operacionIntradia, fechaSistema);

    if (Constantes.BANCO_BOGOTA.equals(operacionIntradia.getBancoAVAL())
   ...
   * @return
   */
  private int procesarContabilidadConsignacion(String tipoProceso,
      OperacionesProgramadasDTO operacionProgramada, Date fechaSistema) {

    generarTransaccionInterna(tipoProceso, 10, operacionProgramada,
   ...
   * @return
   */
  private int procesarContabilidadRetiro(String tipoProceso,
      OperacionesProgramadasDTO operacionProgramada, Date fechaSistema) {
    generarTransaccionInterna(tipoProceso, 20, operacionProgramada,
        operacionProgramada.getCodigoFondoTDV(), fechaSistema);

    if (!Objects.isNull(operacionProgramada.getComisionBR())
        && operacionProgramada.getComisionBR() > 0) {
      TransaccionesInternasDTO transaccionInternaDTOComision =
          generarTransaccionInterna(tipoProceso, 21, operacionProgramada,
              operacionProgramada.getCodigoFondoTDV(), fechaSistema);
      ...
      if (isCiudadCobroIVA(operacionProgramada.getCodigoFondoTDV())) {
        TransaccionesInternasDTO transaccionInternaDTOImpuesto =
            generarTransaccionInterna(tipoProceso, 22, operacionProgramada,
                operacionProgramada.getCodigoFondoTDV(), fechaSistema);
        valorImpuesto =
            this.calcularValorImpuesto(operacionProgramada.getComisionBR(), Dominios.IMPUESTO_IVA);
      ...
      TransaccionesInternasDTO transaccionInternaDTOMedioPago =
          generarTransaccionInterna(tipoProceso, 23, operacionProgramada,
              operacionProgramada.getCodigoFondoTDV(), fechaSistema);
   ...
   * @return
   */
  private int procesarContabilidadVenta(String tipoProceso,
      OperacionesProgramadasDTO operacionProgramada, Date fechaSistema) {
    ...
    if (operacionProgramada.getEntradaSalida().equals("ENTRADA")) {
      ...
      TransaccionesInternasDTO transaccionInternaDTOVenta10 = generarTransaccionInterna(tipoProceso,
          20, operacionProgramada, operacionProgramada.getCodigoFondoTDV(), fechaSistema);
      ...
      if (Integer.valueOf(operacionProgramada.getTasaNegociacion()) > 0) {
        TransaccionesInternasDTO transaccionInternaDTOVenta11 =
            generarTransaccionInterna(tipoProceso, 21, operacionProgramada,
                operacionProgramada.getCodigoFondoTDV(), fechaSistema);

        Double valorComisionDouble = (operacionProgramada.getValorTotal()
            * Double.valueOf(operacionProgramada.getTasaNegociacion()).intValue()) / 10000;
        ...
        BancosDTO bancoDestinoDTO =
            bancosService.validarPuntoBancoEsAval(puntoBancoExterno.getCodigoPunto());
        if (Objects.isNull(bancoDestinoDTO)
            && isCiudadCobroIVA(operacionProgramada.getCodigoFondoTDV())) {
          TransaccionesInternasDTO transaccionInternaDTOVenta12 =
              generarTransaccionInterna(tipoProceso, 22, operacionProgramada,
                  operacionProgramada.getCodigoFondoTDV(), fechaSistema);
        ...
        TransaccionesInternasDTO transaccionInternaDTOVenta13 =
            generarTransaccionInterna(tipoProceso, 23, operacionProgramada,
                operacionProgramada.getCodigoFondoTDV(), fechaSistema);
      ...
      TransaccionesInternasDTO transaccionInternaDTOVenta20 = generarTransaccionInterna(tipoProceso,
          10, operacionProgramada, operacionProgramada.getCodigoFondoTDV(), fechaSistema);
      ...
      if (Integer.valueOf(operacionProgramada.getTasaNegociacion()) > 0) {
        ...
        TransaccionesInternasDTO transaccionInternaDTOVenta21 =
            generarTransaccionInterna(tipoProceso, 11, operacionProgramada,
                operacionProgramada.getCodigoFondoTDV(), fechaSistema);
        transaccionInternaDTOVenta21.setTasaNegociacion(operacionProgramada.getTasaNegociacion());
        Double valorComisionDouble = (operacionProgramada.getValorTotal()
            * Integer.valueOf(operacionProgramada.getTasaNegociacion())) / 10000;
        valorComision = valorComisionDouble.longValue();
        ...
        if (Objects.isNull(bancoDestinoDTO)
            && isCiudadCobroIVA(operacionProgramada.getCodigoFondoTDV())) {
          TransaccionesInternasDTO transaccionInternaDTOVenta22 =
              generarTransaccionInterna(tipoProceso, 12, operacionProgramada,
                  operacionProgramada.getCodigoFondoTDV(), fechaSistema);
          valorImpuesto = this.calcularValorImpuesto(valorComision, Dominios.IMPUESTO_IVA);
        ...
        TransaccionesInternasDTO transaccionInternaDTOVenta23 =
            generarTransaccionInterna(tipoProceso, 13, operacionProgramada,
                operacionProgramada.getCodigoFondoTDV(), fechaSistema);
   ...
   * @return
   */
  private int procesarContabilidadTraslado(String tipoProceso,
      OperacionesProgramadasDTO operacionProgramada, Date fechaSistema) {

    if (Constantes.NOMBRE_SALIDA.equals(operacionProgramada.getEntradaSalida())) {
      TransaccionesInternasDTO transaccionInternaDTOTraslado10 =
          generarTransaccionInterna(tipoProceso, 10, operacionProgramada,
      ...
      TransaccionesInternasDTO transaccionInternaDTOTraslado20 =
          generarTransaccionInterna(tipoProceso, 20, operacionProgramada,
   ...
   * @return
   */
  private int procesarContabilidadIntercambio(String tipoProceso,
      OperacionesProgramadasDTO operacionProgramada, Date fechaSistema) {

    if (Constantes.NOMBRE_SALIDA.equals(operacionProgramada.getEntradaSalida())) {
      TransaccionesInternasDTO transaccionInternaDTOInter10 = generarTransaccionInterna(tipoProceso,
          10, operacionProgramada, operacionProgramada.getCodigoFondoTDV(), fechaSistema);
      transaccionesInternasService.saveTransaccionesInternasById(transaccionInternaDTOInter10);
    } // es una entrada
    else {
      TransaccionesInternasDTO transaccionInternaDTOInter20 = generarTransaccionInterna(tipoProceso,
          20, operacionProgramada, operacionProgramada.getCodigoFondoTDV(), fechaSistema);
   ...
   * @return
   */
  private int procesarContabilidadConsignacionCambio(String tipoProceso,
      OperacionesProgramadasDTO operacionProgramada, Date fechaSistema) {

    TransaccionesInternasDTO transaccionInternaDTOConsignacion10 =
        generarTransaccionInterna(tipoProceso, 10, operacionProgramada,
            operacionProgramada.getCodigoFondoTDV(), fechaSistema);
   ...
   * @return
   */
  private int procesarContabilidadRetiroCambio(String tipoProceso,
      OperacionesProgramadasDTO operacionProgramada, Date fechaSistema) {

    TransaccionesInternasDTO transaccionInternaDTO = generarTransaccionInterna(tipoProceso, 20,
  ...
  private TransaccionesInternasDTO generarTransaccionInterna(String tipoProceso,
      Integer tipoTransaccion, OperacionesProgramadasDTO operacionProgramada, Integer codigoPunto,
      Date fechaSistema) {
    ...
    TransaccionesInternasDTO transaccionInternaDTO = TransaccionesInternasDTO.builder()
        ...
        .codigoMoneda(operacionProgramada.getCodigoMoneda()).valor(valorD.longValue()).tasaEjeCop(1)
        .tasaNoEje(1).tipoOperacion(operacionProgramada.getTipoOperacion()).tipoProceso(tipoProceso)
        .estado(Dominios.ESTADO_CONTABILIDAD_GENERADO).esCambio(false).build();
    ...
    TransportadorasDTO transportadoraDTO =
        transportadorasService.getTransportadoraPorCodigo(fondoDTO.getTdv());
   ...
   * @return
   */
  private TransaccionesInternasDTO generarTransaccionInternaIntradia(String tipoProceso,
      String tipoConcepto, OperacionIntradiaDTO transaccionIntradia, Date fechaSistema) {

    int tipoTransaccion =
        Constantes.NOMBRE_SALIDA.equals(transaccionIntradia.getEntradaSalida()) ? 11 : 21;
    if (ObjectUtils.notEqual(tipoConcepto, "C")) {
      tipoTransaccion = "I".equals(tipoConcepto) ? tipoTransaccion + 1 : tipoTransaccion + 2;
    }
    TransaccionesInternasDTO transaccionInternaDTO = TransaccionesInternasDTO.builder()
        .idOperacion(null).idGenerico(Constantes.ID_GENERICO)
        .consecutivoDia(String.valueOf(consecutivoDia)).codigoMoneda("COP")
        .valor(dominioService
            .valorNumericoDominio(Constantes.DOMINIO_COMISIONES, Dominios.COMISION_3).longValue())
        .tasaEjeCop(1).tasaNoEje(1).tipoTransaccion(tipoTransaccion).tipoOperacion("VENTA")
        .tipoProceso(tipoProceso).estado(Dominios.ESTADO_CONTABILIDAD_GENERADO)
        .codigoComision(Integer.valueOf(Dominios.COMISION_3)).esCambio(false).fecha(fechaSistema)
        .build();

    BancosDTO bancoAval = bancosService.findBancoByCodigoPunto(transaccionIntradia.getBancoAVAL());
    transaccionInternaDTO.setBancoAval(bancoAval);

    PuntosDTO puntoBancoAval =
        PuntosDTO.CONVERTER_DTO.apply(puntosService.getPuntoById(bancoAval.getCodigoPunto()));
    transaccionInternaDTO.setCodigoPunto(puntoBancoAval);

    BancosDTO bancoDestino =
        bancosService.findBancoByCodigoPunto(transaccionIntradia.getCodigoPunto());
    PuntosDTO puntoBancoDestino =
        PuntosDTO.CONVERTER_DTO.apply(puntosService.getPuntoById(bancoDestino.getCodigoPunto()));
  ...
  private PuntosDTO puntoConsultarBancoAval(PuntosDTO punto) {
    if (punto.getTipoPunto().equals(dominioService.valorTextoDominio(Constantes.DOMINIO_TIPOS_PUNTO,
