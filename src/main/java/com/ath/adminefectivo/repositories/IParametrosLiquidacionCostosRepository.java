...
public interface IParametrosLiquidacionCostosRepository extends JpaRepository<ParametrosLiquidacionCosto, Integer>, QuerydslPredicateExecutor<ParametrosLiquidacionCosto> {
