...
public class PuntosJdbcRepositoryImpl implements IPuntosJdbcRepository {
    ...
    public Puntos findPuntoByCodigoAval(Integer codigoAval) {        
        try (Connection conn = dataSource.getConnection();
            ...
            throw new RuntimeException("Error consultando Punto", e);
        }
    }
    ...
    public Boolean existsByTipoPuntoAndCodigoPunto(String tipoPunto, Integer codigoPunto) {
        ...
        try (Connection conn = dataSource.getConnection();
            ...
            log.error("Error verificando existencia de punto - tipo: {}, código: {}", 
                     tipoPunto, codigoPunto, e);
            throw new RuntimeException("Error verificando existencia de punto", e);
        }
    }
    ...
    private Puntos mapResultSetToEntity(ResultSet rs) throws SQLException {
        return Puntos.builder()
            ...
            .tipoPunto(rs.getString("TIPO_PUNTO"))
            .nombrePunto(rs.getString("NOMBRE_PUNTO"))
            .codigoCiudad(rs.getString("CODIGO_CIUDAD"))
            .estado(rs.getString("ESTADO"))
            // 	No se cargan las relaciones para optimizar el desempeño
            .oficinas(null)
            .sitiosClientes(null)
            .puntosCodigoTDV(null)
            .fondos(null)
            .cajeroATM(null)
            .bancos(null)
            .build();
