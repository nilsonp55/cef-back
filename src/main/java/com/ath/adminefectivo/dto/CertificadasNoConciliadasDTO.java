...
public class CertificadasNoConciliadasDTO {
   ...
   * @author cesar.castano
   */
  public static final Function<CertificadasNoConciliadasDTO, OperacionesCertificadas> CONVERTER_ENTITY =
      (CertificadasNoConciliadasDTO t) -> {
   ...
   * @author cesar.castano
   */
  public static final Function<OperacionesCertificadas, CertificadasNoConciliadasDTO> CONVERTER_DTO =
      (OperacionesCertificadas t) -> {
